...
public final class FastReflection {
    ...
    public static final String CMA_PACKAGE = "com.mojang.authlib";
    ...
    public static String cmaClassName(String className) {
        return CMA_PACKAGE + '.' + className;
    }

    public static Class<?> cmaClass(String className) throws ClassNotFoundException {
        return Class.forName(cmaClassName(className));
    }

    public static Optional<Class<?>> cmaOptionalClass(String className) {
        return optionalClass(obcClassName(className));
    }
    ...
    public static Object getEnum(Class<?> enumClass, int position) {
        Object[] constants = enumClass.getEnumConstants();
        if (constants.length > position)
            return constants[position];
        throw new IllegalStateException();
    }

    public static int enumLength(Class<?> enumClass) {
